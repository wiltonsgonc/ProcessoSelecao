        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgenciaFomento = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NivelBolsa = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LinkLattes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UltimaFormacao = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Cargo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    NivelCnpq = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TituloProjeto = table.Column<string>(type: "nvarchar(max)", nullable: true),
